...
# Default configuration file for CYTxxx families of microcontrollers.
...
set_or_global TRAVEO_VARIANT_C2D_4M     0
set_or_global TRAVEO_VARIANT_BH_16M     0

if { $TRAVEO_VARIANT_C2D_4M != 0} {
	set FLASH_DRIVER_NAME traveo21
	set ENABLE_CM71 0
	set ENABLE_CM72 0
	set ENABLE_CM73 0
} elseif { $TRAVEO_VARIANT_BH_16M != 0} {
	set FLASH_DRIVER_NAME traveo23
	set ENABLE_CM71 1
	set ENABLE_CM72 1
	set ENABLE_CM73 1
} else {
	# BH_8M
	set FLASH_DRIVER_NAME traveo22
	set ENABLE_CM71 1
	set ENABLE_CM72 0
	set ENABLE_CM73 0
}
...
set_or_global WORKAREASIZE              0x00020000
